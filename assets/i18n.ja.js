...
"ja": {
  ...
  "ab.pillars": [{"t":"何よりも誠実さを重んじる","b":"お約束したことは必ず実現します。隠れた費用や曖昧な見積もりはありません。"},{"t":"必要な時に受けられるメンテナンス","b":"毎月のメンテナンスはオプションです：月額 €29 または年額 €250。これを追加すれば、手間をかけずに、サイトのセキュリティを確保し、常に最新の状態を保ち、検索エンジンに適切にインデックスされる状態を維持できます。"},{"t":"地域に根ざし、デジタルを築く","b":"私たちは、お客様の地域、顧客、市場を熟知しています。ベルギー全土で事業を展開しており、ブリュッセル、アントワープ、ヘント、ルーヴェンからブルージュ、ハッセルト、リエージュ、そしてその間のあらゆる地域までをカバーしています。"}],
